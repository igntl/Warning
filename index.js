const { Client, GatewayIntentBits, ActionRowBuilder, StringSelectMenuBuilder, SlashCommandBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, EmbedBuilder } = require('discord.js');
...
const ALLOWED_ROLE = "1523520246097514528"; // فقط مسؤولين الشكاوي
...
const DURATIONS = {
  test: { label: "تجربة", time: 60 * 60 * 1000 } // ساعة
};
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.isStringSelectMenu() && interaction.customId === "types") {
    ...
    const hasFixedDuration = data.types.some(t => ["warn1", "warn2", "warn3"].includes(t));
    if (hasFixedDuration) {
